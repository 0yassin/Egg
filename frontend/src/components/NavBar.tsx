...
const getNavLinkClass = ({ isActive }: NavLinkRenderProps): string => (` " relative before:absolute top before:content-[''] before:block before-W-1 before:bg-black "   ${isActive} ? "font-semibold text-[var(--hightlight-text-color)]" : "text-[var(--text-color)]"`);
