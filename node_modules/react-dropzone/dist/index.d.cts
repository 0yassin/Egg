 ...
 */
interface DragFileRejection$1<T extends File | DataTransferItem = File | DataTransferItem> {
  file: T;
...
type DragFileRejection = DragFileRejection$1<FileWithPath | DataTransferItem>;
...
//#endregion
export { type Accept, type AcceptGroup, DragFileRejection, DropEvent, DropzoneInputProps, DropzoneOptions, DropzoneProps, DropzoneRef, DropzoneRootProps, DropzoneState, ErrorCode, type FileError, FileRejection, type FileWithPath, type ValidatorResult, Dropzone as default, useDropzone };
